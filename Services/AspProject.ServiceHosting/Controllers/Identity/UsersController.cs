...
using AspProjectDomain.DTO.Identity;
...
namespace AspProject.ServiceHosting.Controllers.Identity
{
    ...
    public class UsersController : ControllerBase
    {
        ...
        [HttpPost("Role/{role}")]
        public async Task AddToRoleAsync([FromBody] User user, string role, [FromServices] AspProjectDbContext db)
        {
        ...
        public async Task RemoveFromRoleAsync([FromBody] User user, string role, [FromServices] AspProjectDbContext db)
        {
        ...
        [HttpPost("AddClaims")]
        public async Task AddClaimsAsync([FromBody] AddClaimDTO ClaimInfo, [FromServices] AspProjectDbContext db)
        {
        ...
        public async Task ReplaceClaimAsync([FromBody] ReplaceClaimDTO ClaimInfo, [FromServices] AspProjectDbContext db)
        {
        ...
        public async Task RemoveClaimsAsync([FromBody] RemoveClaimDTO ClaimInfo, [FromServices] AspProjectDbContext db)
        {
        ...
        [HttpPost("AddLogin")]
        public async Task AddLoginAsync([FromBody] AddLoginDTO login, [FromServices] AspProjectDbContext db)
        {
        ...
        public async Task RemoveLoginAsync([FromBody] User user, string LoginProvider, string ProviderKey, [FromServices] AspProjectDbContext db)
        {
